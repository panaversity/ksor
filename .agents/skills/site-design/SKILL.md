...
| Trap                                                      | What happens                                                                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--card` is **white** in shadcn's light theme             | A "surface" painted with `bg-fd-card` is invisible on the page. Use `--muted` for a band or panel. **Fumadocs paints its own code block with `bg-fd-card`**, so fenced code read as loose monospace text with a faint outline until `.prose figure.shiki` was given `--muted` — measured 2026-08-22 at under 2% lightness between the block and the page. |
