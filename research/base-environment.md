...
> repo root (no `tools/` package); the predecessor is treated as reference
...
| Human surface (superseded 2026-08-18: shell choice reopened — AGENTS.md open questions, proposal §4) | Docusaurus                                    | `@docusaurus/core` 3.10.2 + `@docusaurus/faster`, `future: { v4: true }`                                                                                                   | Rspack builds stable in 3.10; v4-ready from day one. Unaffected by TS7 API gap.                                                                                                                                           |
