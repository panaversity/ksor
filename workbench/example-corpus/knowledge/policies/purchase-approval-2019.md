...
sources:
  - id: finance-policy-manual-4-2-2019-edition
    ...
    resource: Finance policy manual §4.2, 2019 edition
ksor:
  audience: [public]
  owner: finance
...
withdrawn documents are deprecated, never deleted — an agent citing the 2019
thresholds must be able to discover that they no longer govern.

Historical thresholds: purchases over $25,000 required CFO approval; there was
no split-purchase clause.
